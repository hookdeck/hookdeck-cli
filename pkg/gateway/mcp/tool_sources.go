...
func handleSources(client *hookdeck.Client) mcpsdk.ToolHandler {
...
func sourcesList(ctx context.Context, client *hookdeck.Client, in input) (*mcpsdk.CallToolResult, error) {
