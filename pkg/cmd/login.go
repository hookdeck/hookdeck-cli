...
With a guest Console profile (after hookdeck listen), login signs you up to keep your sandbox data.
To attach the CLI to an existing Hookdeck Platform account instead, run hookdeck logout first.`,
